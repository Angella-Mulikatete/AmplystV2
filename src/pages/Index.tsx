          ...
          <div className="container mx-auto py-20 px-4 text-center relative z-10">
            <div className="max-w-4xl mx-auto relative">
              ...
              >
                ...
                >
                  <motion.div
                    ...
                    animate="animate"
                    className="w-12 h-12 rounded-full bg-gradient-to-br from-pink-400 via-primary to-orange-400 flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow cursor-pointer"
              ...
              >
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-[#3A7CA5] to-[#88B04B] hover:from-[#3A7CA5]/90 hover:to-[#88B04B]/90 text-white px-8 py-4 rounded-full text-lg font-semibold" 
      ...
      <section id="how-it-works" className="w-full bg-white relative">
        <div className="container mx-auto py-12 md:py-20 px-4">
          ...
          <div className="lg:hidden">
            ...
            <div className="min-h-[300px] md:min-h-[200px] relative" style={{ perspective: '1000px' }}>
              <AnimatePresence mode="wait">
                <motion.div
                  key={currentIndex}
                  variants={flipVariants}
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="max-w-6xl mx-auto relative">
            ...
            >
              ...
              {/* Navigation Buttons */}
              {/* <Button
                className="absolute left-2 md:left-4 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 md:p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 z-10 backdrop-blur-sm"
                onClick={() => paginate(-1)}
                whileTap={{ scale: 0.95 }}
              >
              ...
              <Button
                className="absolute right-2 md:right-4 top-1/2 transform -translate-y-1/2 bg-white/80 hover:bg-white text-gray-800 p-2 md:p-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 z-10 backdrop-blur-sm"
                onClick={() => paginate(1)}
                whileTap={{ scale: 0.95 }}
              >
