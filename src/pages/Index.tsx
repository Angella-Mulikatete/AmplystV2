    ...
    <div className="min-h-screen bg-gradient-to-br from-[#3A7CA5]/5 to-[#88B04B]/5">
        ...
        <div className="container mx-auto py-20 px-4 text-center relative z-10">
          ...
          <div className="max-w-4xl mx-auto relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              {/* Facebook - Top */}
              <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 w-12 h-12 rounded-full bg-blue-600 flex items-center justify-center">
                <span className="text-white font-bold text-lg">f</span>
              </div>
              
              {/* Instagram - Top Right */}
              <div className="absolute top-4 right-8 w-12 h-12 rounded-full bg-gradient-to-br from-pink-400 via-purple-500 to-orange-400 flex items-center justify-center">
              ...
              <div className="absolute bottom-4 right-8 w-12 h-12 rounded-full bg-black flex items-center justify-center">
                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.08 1.4-.54 2.7-1.35 3.94-1.31 2.08-3.59 3.47-5.98 3.51-1.43.05-2.83-.14-4.08-.72-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.88-2.02 4.35-3.44 7.07-3.47H12.525zM10.02 8.18v3.96c-.19-.02-.39-.13-.55-.22-.74-.42-1.18-1.1-1.18-1.89 0-.94.48-1.69 1.31-2.07.17-.09.37-.14.56-.16.02.01.02.01.01.04z"/>
                </svg>
              </div>
            </div>
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight relative z-10">
              ...
              <span className="relative">
                ...
                <svg className="absolute -top-2 -right-8 w-8 h-8 text-purple-500" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12 relative z-10">
              ...
              <Button size="lg" variant="outline" className="border-purple-600 text-purple-600 hover:bg-purple-50 px-8 py-4 rounded-full text-lg font-semibold">
      ...
      <section className="w-full bg-gradient-to-br from-pink-50 to-orange-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute bottom-0 right-0 w-32 h-32 bg-purple-200 rounded-full opacity-30"></div>
