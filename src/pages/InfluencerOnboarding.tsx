...
const InfluencerOnboarding = () => {
  ...
  // Helper to get follower count from primary platform
// const getPrimaryAccountFollowerCount = () => {
//   if (!formData.primaryPlatform || !formData.profileData) return "0";
  
//   const platform = formData.primaryPlatform;
//   const data = formData.profileData[platform];
  
//   if (platform === "tiktok") {
//     return data?.fans?.toString() || "0";
//   } else if (platform === "instagram") {
//     return data?.followersCount?.toString() || "0";
//   }
//   }
